...
int main() {
	...
	int n;
	cout << "¬ведите количество букв в слове:" << endl;
	cin >> n;
	char* mas = new char[n];
	...
	char arr3[10];
	cout << endl << "¬ведите новое расширение: ";
	cin.getline(arr3, 10);
	...
	char arr5[30];
	cout << endl << "¬ведите слово, которое нужно подсчитать: ";
	cin.getline(arr5, 30);
